...
function Footer() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const shouldBeVisible = scrollDirection || currentScrollPos < 1000;
  ...
  return (
    <>
      ...
      >
        <div className="footer-container">
          <div className="footer-branding">
            ...
            <h3 className="brand-tagline">Better drives, better lives</h3>
          </div>
          <div className="footer-content">
            <div className="footer-links-grid">
              ...
              <div className="footer-links-section">
                ...
                <ul className="footer-links-list">
                  ...
                  <li>
                    <Link to="/sell-car">Sell Used Car</Link>
                  </li>
                  {/* <li>
                      <Link to="/carlisting">Used Car Valuation</Link>
                    </li> */}
                </ul>
              </div>
              <div className="footer-links-section">
            ...
            <div className="footer-social-section">
              <h4 className="footer-section-title">Social Links</h4>
          ...
          <p className="copyright">© 2025 Gadi Dikhao, All rights reserved</p>
        </div>
      </footer>
      ...
      >
        <nav className="mobile-footer-navbar">
          ...
          >
            ...
            <span className="mobile-footer-nav-label">Buy car</span>
          </button>
          ...
          >
            ...
            <span className="mobile-footer-nav-label">Sell car</span>
          </button>
      ...
      <Link
        to="https://wa.me/918742995656?text=Hello%20I%20would%20like%20to%20make%20an%20enquiry."
        className="float"
        target="_blank"
      >
