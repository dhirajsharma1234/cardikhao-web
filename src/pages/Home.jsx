...
const SERVICE_ITEMS = [
  ...
  { title: "Car Finance", to: "#", type: "finance" },
  { title: "Scrap Your Car", to: "#", type: "scrap" },
  { title: "Car Services", to: "/coming-soon" },
];
...
const NEWS_ITEMS = [
  {
    title:
      "Most expensive electric car in India launched — Top things to know!",
  ...
  {
    title:
      "Mahindra XUV700 facelift spotted with production-spec headlights, alloy wheels",
    category: "Auto Insider",
  ...
  {
    title:
      "Tata Harrier EV safety rating revealed — Achieves five stars in BNCAP",
    category: "Auto Insider",
  ...
  {
    title:
      "Latest Toyota cars offers and discounts in June 2025 — Save up to Rs 1.46 lakh",
    category: "Auto Insider",
...
function Home() {
  ...
  const handleServiceClick = (service) => {
    if (
      ...
      setContactFormType(service.type);
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("assets/images/slider/banner-pic.webp")',
        }}
      >
            ...
            <div className="searchInput__wrapper">
              <div className="interactiveElement">
                <div className="searchInput__field">
                  ...
                  />
                  <button
                    className="brand-btn custom-search-btn"
            ...
            <div className="service-list m-view-none">
              {SERVICE_ITEMS.map((item, index) => (
                <Link
                  ...
                  onClick={(e) => {
                    if (item.type && handleServiceClick(item) === false) {
                      e.preventDefault();
                    }
                  }}
                >
                  <div className="service-item-inner">
                    <img
                      loading="eager"
                      src={`assets/images/services/service-${index + 1}.png`}
                      alt={`icon-${item.title}`}
                      className="service-item-img"
                    />
                    <p
                      className={`service-title ${index === 0 ? "active" : ""}`}
                    >
                      {item.title}
                    </p>
                  </div>
        ...
        <div className="cars-container">
          <div className="cars-header">
            <div className="cars-header-content">
              ...
              <p className="cars-subtitle">Quality used cars at great prices</p>
            </div>
                ...
                <div className="cars-tab-item">
                  <div className="cars-active-tab">
                    <div className="cars-tab-content">
                      <p className="cars-tab-label">Recently Added</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                {carsData.cars.length > 0 &&
                  carsData.cars.map((car) => (
                    <SwiperSlide key={car._id} className="cars-slide">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h2>
                  Search for your favorite car or sell your car on Gadi Dikhao
                </h2>
              </div>
            </div>
              ...
              <div className="tf-icon-box style-3 mg-42">
                ...
                <div className="content">
                  ...
                  <div className="meta style">
                    <Link to="/carlisting" className="sc-button btn-svg btn-55">
                      <span>Find cars</span>
            ...
            <div className="col-md-4">
              <div className="tf-icon-box style-3 mg-42">
                <div className="inner-wrap flex-three">
                  ...
                  <h3>
                    <Link to="/sell-car">Do you want to sell a car?</Link>
                  </h3>
                </div>
                <div className="content">
                  <p>
                    Find your perfect car match and sell your car quickly with
                    our user-friendly online service.
                  </p>
                  <div className="meta style">
                    <Link to="/sell-car" className="sc-button btn-svg btn-55">
      ...
      {/* Services Section - Updated to handle form opening */}
      <div id="services-section">
        <div className="services-container container">
          <div className="services-content">
            <h2 className="section-heading blue-accent">Our services</h2>
      ...
      <div className="car-category pt-40">
        <div className="container">
          <h2 className="section-heading blue-accent">Cars by category</h2>
          <div className="tab-component">
            ...
            <div className="tab-content">
              ...
              <div
                id="car-budget-panel"
                className={`tab-panel ${
                  activeTab === "car-budget-tab" ? "active" : ""
                }`}
                role="tabpanel"
                  ...
                  <div>
                    <div className="used-cars-tabs budget-filter">
                      <ul className="tabs-list">
                        {CAR_BUDGET.map((budget, index) => (
                          <li key={index} className="tab-item">
                            <Link
                              to={`${budget.to}?${budget.filter}`}
                              className="tab-link"
                            >
                              <span className="tab-prefix">Cars under </span>
      ...
      >
        <div className="auto-news-container container">
          <h2 className="section-heading blue-accent">What motivates us</h2>
          <TestiMonial />
        </div>
      </div>
              ...
              {[
                {
                  ...
                  description: "Get instant support via experts",
                ...
                <div key={index} className="help-option">
                  <Link
                    ...
                    className="help-card"
                    onClick={(e) => {
                      if (option.type && handleServiceClick(option) === false) {
                        e.preventDefault();
                      }
                    }}
                  >
                    ...
                    <div className="help-card__content">
                      <h3 className="help-card__title">{option.title}</h3>
