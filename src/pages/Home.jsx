...
const SERVICE_ITEMS = [
  ...
  { title: "Car finance", to: "/coming-soon" },
  { title: "New cars", to: "/coming-soon" },
            ...
            <div className="service-wrap m-view-none">
              <div className="service-list m-view-none">
                {SERVICE_ITEMS.map((item, index) => (
                  <Link key={index} to={item.to} className="service-item">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="tf-icon-box style-3 mg-42">
                  ...
                  <div className="content">
                    <p>
                      Save time and effort as you no longer need to visit
                      multiple stores to find the right car.
                    </p>
