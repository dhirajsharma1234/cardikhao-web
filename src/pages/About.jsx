                ...
                <div className="content relative z-2">
                  <div className="heading">
                    <h1 className="text-color-1">
                      Buy or Sell Cars <br /> The Smart & Easy Way!
                    </h1>
                    <p className="text-color-1 fs-18 fw-4 lh-22 font">
                      Gadi Dikhao is your trusted platform to buy your dream car
                      or <br />
                      sell your vehicle quickly at the best value — all without
                      any hassle.
                    </p>
                    <Link to="/carlisting" className="sc-button btn-svg">
              ...
              <div className="col-md-6">
                <div className="content-wcs">
                  <div className="heading-section">
                    <h2>Why Choose Gadi Dikhao</h2>
                    <p className="mt-18">
                      Gadi Dikhao is an online portal that connects buyers to
                      their dream vehicles and helps sellers find valuable
                      clients easily. With smart tools and a seamless interface,
                      we make the process of buying and selling vehicles faster
                  ...
                  <div className="tf-icon-box-list">
                    <div className="tf-icon-box style-2">
                      ...
                      <div className="content">
                        ...
                        <p>
                          Gadi Dikhao is your one-stop solution for buying and
                          selling vehicles with complete ease and transparency.
                        </p>
                      </div>
                    </div>
                    <div className="tf-icon-box style-2">
                      ...
                      <div className="content">
                        ...
                        <p>
                          Our platform allows buyers to explore a wide range of
                          verified listings, helping them find their perfect car
                          effortlessly.
                        </p>
                      </div>
                    </div>
                    <div className="tf-icon-box style-2">
                      ...
                      <div className="content">
                        <h5>
                          <a href="#">Sell Without Hassle</a>
                        </h5>
                        <p>
                          Sellers can list their vehicles in a few simple steps
                          and connect with genuine buyers to get the best value
                          for their cars.
                        </p>
                      </div>
                    </div>
